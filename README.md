...
The preset ``` HDM-camp.xml ``` is available through the preset list in JOSM (https://josm.openstreetmap.de/wiki/Presets) and the preset ``` HDM-camp-vespucci.xml ``` can be used with the application vespucci on Android Smartphone: https://play.google.com/store/apps/details?id=de.blau.android

The presets have been organised to match sectors terminology as known by humanitarian workers. 
...
Optional: 
*  Customize the visual display of features 
...
*  Optional: Custom Tile urls can also be added using the SlippyMap plugin, see: http://wiki.openstreetmap.org/wiki/JOSM/Plugins/SlippyMap#Custom_tile_URLS
...
*  OSM Beginner's Guide http://wiki.openstreetmap.org/
*  JOSM Introduction http://wiki.openstreetmap.org/wiki/Josm
*  Potlatch Introduction http://wiki.openstreetmap.org/wiki/Potlatch
*  Potlatch Getting Started video http://www.youtube.com/watch?v=Oio1jY8WNig
*  Editing Roads in Potlatch http://www.youtube.com/watch?v=D6pBBK1SHh0
*  Editing Camp in Potlatch http://www.youtube.com/watch?v=Oio1jY8WNig
*  Using presets in Potlatch http://www.youtube.com/watch?v=YAnt2RSaEEA&fmt=18
